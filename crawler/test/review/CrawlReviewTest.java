...
public class CrawlReviewTest extends UnitTest {
    ...
    @Before
    public void setUp() {
        newPage = Jsoup.parse(IO.readContentAsString(Play.getFile("test/html/B007H4J80K_1.html")));
        oldPage = Jsoup.parse(IO.readContentAsString(Play.getFile("test/html/B007H4J80K_1_old.html")));
    }
