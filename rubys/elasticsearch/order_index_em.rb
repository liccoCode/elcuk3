...
SQL = <<SQL
select s.asin, s.upc, o.orderId, o.account_id, group_concat(distinct(oi.promotionIDs)) promotionIDs, concat_ws(' ', o.address, o.address1) address, o.arriveDate, o.createDate, o.paymentDate, o.shipDate, o.buyer, o.email, o.market, o.state, o.trackNo, o.userid, group_concat(oi.selling_sellingId, "@") sids 
from Orderr o
