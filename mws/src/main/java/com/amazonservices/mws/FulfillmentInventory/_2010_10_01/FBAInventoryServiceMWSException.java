 ...
 *
 */
public class FBAInventoryServiceMWSException extends Exception {
    ...
    public FBAInventoryServiceMWSException(Throwable t) {
        super(t);
        if (t instanceof FBAInventoryServiceMWSException) {
     ...
     */
    public FBAInventoryServiceMWSException(String message, int statusCode, String errorCode, String errorType, String requestId,  String xml) {
