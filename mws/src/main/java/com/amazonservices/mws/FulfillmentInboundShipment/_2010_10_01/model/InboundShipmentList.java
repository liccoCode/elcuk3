...
/**
 * <p>Java class for InboundShipmentList complex type.
 * 
...
public class InboundShipmentList {

    @XmlElement(required = true)
    protected List<InboundShipmentInfo> member;
     ...
     * 
     */
    public InboundShipmentList(final List<InboundShipmentInfo> member) {
        this.member = member;
    }
    ...
    protected String toXMLFragment() {
        ...
        java.util.List<InboundShipmentInfo> memberList = getMember();
