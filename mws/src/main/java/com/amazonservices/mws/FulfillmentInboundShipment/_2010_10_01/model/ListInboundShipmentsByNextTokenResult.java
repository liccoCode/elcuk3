...
public class ListInboundShipmentsByNextTokenResult {
    ...
    protected InboundShipmentList shipmentData;
     ...
     * 
     */
    public ListInboundShipmentsByNextTokenResult(final InboundShipmentList shipmentData, final String nextToken) {
        this.shipmentData = shipmentData;
        this.nextToken = nextToken;
    }

    /**
     * Gets the value of the shipmentData property.
     * 
     * @return
     *     possible object is
     *     {@link InboundShipmentList }
     *     
     */
    ...
    /**
     * Sets the value of the shipmentData property.
     * 
     * @param value
     *     allowed object is
     *     {@link InboundShipmentList }
     *     
     */
    public void setShipmentData(InboundShipmentList value) {
        this.shipmentData = value;
    }

    public boolean isSetShipmentData() {
        return (this.shipmentData!= null);
    }
     ...
     *     this instance
     */
    public ListInboundShipmentsByNextTokenResult withShipmentData(InboundShipmentList value) {
     ...
     *     this instance
     */
    public ListInboundShipmentsByNextTokenResult withNextToken(String value) {
        setNextToken(value);
        return this;
    }
    ...
    protected String toXMLFragment() {
        ...
        if (isSetShipmentData()) {
            InboundShipmentList  shipmentData = getShipmentData();
            xml.append("<ShipmentData>");
            xml.append(shipmentData.toXMLFragment());
            xml.append("</ShipmentData>");
        } 
        if (isSetNextToken()) {
    ...
    protected String toJSONFragment() {
        ...
        if (isSetShipmentData()) {
            ...
            json.append("\"ShipmentData\" : {");
            InboundShipmentList  shipmentData = getShipmentData();


            json.append(shipmentData.toJSONFragment());
            json.append("}");
            first = false;
        }
        if (isSetNextToken()) {
