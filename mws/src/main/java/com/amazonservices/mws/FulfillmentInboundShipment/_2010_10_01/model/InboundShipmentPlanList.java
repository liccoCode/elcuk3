...
/**
 * <p>Java class for InboundShipmentPlanList complex type.
 * 
...
public class InboundShipmentPlanList {

    @XmlElement(required = true)
    protected List<InboundShipmentPlan> member;
     ...
     * 
     */
    public InboundShipmentPlanList(final List<InboundShipmentPlan> member) {
        this.member = member;
    }
    ...
    protected String toXMLFragment() {
        ...
        java.util.List<InboundShipmentPlan> memberList = getMember();
