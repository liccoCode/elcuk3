...
/**
 * Configuration for accessing FBA Inbound Service MWS  service
 */
public class FBAInboundServiceMWSConfig {
    ...
    /**
     * Sets SignatureMethod property and returns current FBAInboundServiceMWSConfig
     *
     * @param signatureMethod Signature Method for signing requests
     *
     * @return FBAInboundServiceMWSConfig
     */
    ...
    /**
     * Sets UserAgent property and returns current FBAInboundServiceMWSConfig
     *
     * @param userAgent User Agent String to use when sending request
     *
     * @return FBAInboundServiceMWSConfig
     */
    public FBAInboundServiceMWSConfig withUserAgent(
            String applicationName, 
            String applicationVersion, 
            String programmingLanguage, 
            String... additionalNameValuePairs) {
    ...
    /**
     * Sets ServiceURL property and returns current FBAInboundServiceMWSConfig
     *
     * @param serviceURL Service Endpoint URL
     *
     * @return FBAInboundServiceMWSConfig
    ...
    /**
     * Sets ProxyHost property and returns current FBAInboundServiceMWSConfig
     *
     * @param proxyHost Proxy Host for connection
     *
     * @return FBAInboundServiceMWSConfig
    ...
    /**
     * Sets ProxyPort property and returns current FBAInboundServiceMWSConfig
     *
     * @param proxyPort Proxy Port for connection
     *
     * @return FBAInboundServiceMWSConfig
    ...
    /**
     * Sets ProxyUsername property and returns current FBAInboundServiceMWSConfig
     *
     * @param proxyUsername Proxy Username for connection
     *
     * @return FBAInboundServiceMWSConfig
    ...
    /**
     * Sets ProxyPassword property and returns current FBAInboundServiceMWSConfig
     *
     * @param proxyPassword Proxy Password for connection
     *
     * @return FBAInboundServiceMWSConfig
    ...
    /**
     * Sets MaxAsyncThreads property and returns current FBAInboundServiceMWSConfig
     *
     * @param maxAsyncThreads Max number of threads to spawn for async operation.
     * Note, this parameter works in conjuction with MaxAsyncQueueSize. When
     * Max number of threads is reached, requests will be stored in the queue.
     ...
     * @return FBAInboundServiceMWSConfig
     */
    public FBAInboundServiceMWSConfig withMaxAsyncThreads(int maxAsyncThreads) {
    ...
    /**
     * Sets MaxAsyncQueueSize property and returns current FBAInboundServiceMWSConfig
     *
     * @param maxAsyncQueueSize Max number of requests to queue when max number of
     * threads is reached, and all threads are busy processing.
     *
     ...
     *
     */
    public FBAInboundServiceMWSConfig withMaxAsyncQueueSize(int maxAsyncQueueSize) {
