 ...
 *
 */
public class ListInboundShipmentsByNextTokenSample {
    ...
    public static void main(String... args) {
         ...
         * sample for List Inbound Shipments By Next Token 
         ***********************************************************************/
     ...
     */
    public static void invokeListInboundShipmentsByNextToken(FBAInboundServiceMWS service, ListInboundShipmentsByNextTokenRequest request) {
        try {
            
            ListInboundShipmentsByNextTokenResponse response = service.listInboundShipmentsByNextToken(request);

            
            System.out.println ("ListInboundShipmentsByNextToken Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    ListInboundShipmentsByNextTokenResponse");
            System.out.println();
            if (response.isSetListInboundShipmentsByNextTokenResult()) {
                System.out.println("        ListInboundShipmentsByNextTokenResult");
                System.out.println();
                ListInboundShipmentsByNextTokenResult  listInboundShipmentsByNextTokenResult = response.getListInboundShipmentsByNextTokenResult();
                ...
                if (listInboundShipmentsByNextTokenResult.isSetNextToken()) {
                    ...
                    System.out.println();
                    System.out.println("                " + listInboundShipmentsByNextTokenResult.getNextToken());
                    System.out.println();
                }
            } 
