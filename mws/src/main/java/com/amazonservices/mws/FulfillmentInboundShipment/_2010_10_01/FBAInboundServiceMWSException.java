 ...
 *
 */
public class FBAInboundServiceMWSException extends Exception {
    ...
    /**
     * Constructs FBAInboundServiceMWSException with message
     * @param message
     *          Overview of error
     */
    ...
    /**
     * Constructs FBAInboundServiceMWSException with message and status code
     * @param message
     *          Overview of error
     * @param statusCode
     *          HTTP status code for error response
     */
    public FBAInboundServiceMWSException(String message, int statusCode) {
        this.message = message;
        this.statusCode = statusCode;
    }
    
    /**
     * Constructs FBAInboundServiceMWSException with wrapped exception
     * @param t
     *          wrapped exception
     */
    public FBAInboundServiceMWSException(Throwable t) {
        super(t);
        if (t instanceof FBAInboundServiceMWSException) {
            FBAInboundServiceMWSException ex = (FBAInboundServiceMWSException)t;
    ...
    /**
     * Constructs FBAInboundServiceMWSException with message and wrapped exception
     * @param message
     *          Overview of error
     * @param t
     *          wrapped exception
     */
    public FBAInboundServiceMWSException(String message, Throwable t) {
        super(message, t);
        this.message = message;
    }
     ...
     */
    public FBAInboundServiceMWSException(String message, int statusCode, String errorCode, String errorType, String requestId,  String xml) {
