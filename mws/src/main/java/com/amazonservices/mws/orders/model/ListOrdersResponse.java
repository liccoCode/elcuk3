 ...
 *       &lt;sequence>
 *         &lt;element ref="{https://mws.amazonservices.com/Orders/2011-01-01}ListOrdersResult"/>
...
public class ListOrdersResponse {
    ...
    @XmlElement(name = "ListOrdersResult", required = true)
    protected ListOrdersResult listOrdersResult;
     ...
     * 
     */
    public ListOrdersResponse(final ListOrdersResult listOrdersResult, final ResponseMetadata responseMetadata) {
        this.listOrdersResult = listOrdersResult;
        this.responseMetadata = responseMetadata;
    }

    /**
     * Gets the value of the listOrdersResult property.
     * 
     * @return
     *     possible object is
     *     {@link ListOrdersResult }
     *     
     */
    ...
    /**
     * Sets the value of the listOrdersResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link ListOrdersResult }
     *     
     */
    public void setListOrdersResult(ListOrdersResult value) {
     ...
     *     this instance
     */
    public ListOrdersResponse withListOrdersResult(ListOrdersResult value) {
        setListOrdersResult(value);
        return this;
    }
     ...
     *     this instance
     */
    public ListOrdersResponse withResponseMetadata(ResponseMetadata value) {
    ...
    public String toXML() {
        ...
        if (isSetListOrdersResult()) {
            ListOrdersResult  listOrdersResult = getListOrdersResult();
    ...
    public String toJSON() {
        ...
        if (isSetListOrdersResult()) {
            ...
            json.append("\"ListOrdersResult\" : {");
            ListOrdersResult  listOrdersResult = getListOrdersResult();

            json.append(listOrdersResult.toJSONFragment());
            json.append("}");
            first = false;
        } 
        if (isSetResponseMetadata()) {
