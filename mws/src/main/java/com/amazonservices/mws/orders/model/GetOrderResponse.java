 ...
 *       &lt;sequence>
 *         &lt;element ref="{https://mws.amazonservices.com/Orders/2011-01-01}GetOrderResult"/>
...
public class GetOrderResponse {
    ...
    @XmlElement(name = "GetOrderResult", required = true)
    protected GetOrderResult getOrderResult;
     ...
     * 
     */
    public GetOrderResponse(final GetOrderResult getOrderResult, final ResponseMetadata responseMetadata) {
     ...
     *     
     */
    public void setGetOrderResult(GetOrderResult value) {
        this.getOrderResult = value;
    }

    public boolean isSetGetOrderResult() {
        return (this.getOrderResult!= null);
    }
     ...
     *     this instance
     */
    public GetOrderResponse withGetOrderResult(GetOrderResult value) {
        setGetOrderResult(value);
        return this;
    }
     ...
     *     this instance
     */
    public GetOrderResponse withResponseMetadata(ResponseMetadata value) {
    ...
    public String toXML() {
        ...
        if (isSetGetOrderResult()) {
            GetOrderResult  getOrderResult = getGetOrderResult();
    ...
    public String toJSON() {
        ...
        if (isSetGetOrderResult()) {
            ...
            json.append("\"GetOrderResult\" : {");
            GetOrderResult  getOrderResult = getGetOrderResult();

            json.append(getOrderResult.toJSONFragment());
            json.append("}");
            first = false;
        } 
        if (isSetResponseMetadata()) {
