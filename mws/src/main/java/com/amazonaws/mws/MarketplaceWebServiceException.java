...
public class MarketplaceWebServiceException extends Exception {
     ...
     */
    public MarketplaceWebServiceException(String message, int statusCode) {
        this.message = message;
     ...
     */
    public MarketplaceWebServiceException(String message, int statusCode, String errorCode, String errorType, String requestId,  String xml) {
