...
public class GetReportListSample {
    ...
    public static void main(String... args) {
         ...
         * http://aws.amazon.com
         ***********************************************************************/
        final String accessKeyId = "AKIAI6EBPJLG64HWDBGQ";
        final String secretAccessKey = "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";
         ...
         ***********************************************************************/
        final String merchantId = "AJUR3R8UN71M4";

        GetReportListRequest request = new GetReportListRequest();
        request.setMerchant( merchantId );
//        request.setReportTypeList(new TypeList(Lists.newArrayList(ReportType.ORDER_TRACKING_REPORT_XML)));
        request.setReportRequestIdList(new IdList(Arrays.asList("2085038844")));
