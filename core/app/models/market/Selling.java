...
public class Selling extends GenericModel {
    ...
    public void syncFromAmazon() {
        ...
        HTTP.post("http://"+models.OperatorConfig.getVal("companyname")+":4567/amazon_product_sync_back", params);
    ...
    public Feed deploy() {
        ...
        HTTP.post("http://"+models.OperatorConfig.getVal("companyname")+":4567/submit_feed", params);
        return feed;
    }
    ...
    public void uploadFeedAmazonImg(String imageName, boolean waterMark, String userName) {
        ...
        HTTP.post("http://"+models.OperatorConfig.getVal("companyname")+":4567/submit_amazon_image_feed", params);
        this.save();
    }
    ...
    public Selling buildFromProduct() {
        ...
        HTTP.post("http://"+models.OperatorConfig.getVal("companyname")+":4567/submit_feed", this.submitJobParams(feed));
        return this;
    }
    ...
    public void uploadFeedToAmazonForProduct(SellingAmzPost p) throws Exception {
        if(p.rbns || p.productvolume || p.productWeight || p.weight || p.title || p.keyfeturess || p.searchtermss ||
            ...
            HTTP.post("http://"+models.OperatorConfig.getVal("companyname")+":4567/amazon_submit_product_feed", productParams);
        }
        ...
        if(p.standerprice || p.saleprice) {
            ...
            HTTP.post("http://"+models.OperatorConfig.getVal("companyname")+":4567/amazon_submit_price_feed", priceParams);
        }
    }
