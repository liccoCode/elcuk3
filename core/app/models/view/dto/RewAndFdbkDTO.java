...
public class RewAndFdbkDTO implements Serializable {
    ...
    */
    ...
    public RewAndFdbkDTO review(AmazonListingReview review) {
    ...
    private RewAndFdbkDTO feedback(Feedback fdbk) {
        if(fdbk.ticket != null) {
    ...
    @Cached("30mn")
    public static List<RewAndFdbkDTO> reviews(Date from, Date to) {
    ...
    @SuppressWarnings("unchecked")
    @Cached("30mn")
    public static List<RewAndFdbkDTO> feedbacks(Date from, Date to) {
        String cacheKey = String.format("RewAndFdbkDTO.feedback.%s", Caches.Q.cacheKey(from, to));
    ...
    public static void sortByColumn(List<RewAndFdbkDTO> rewAndFdbkDTOs, String c) {
        String column = c;
        if(StringUtils.isBlank(c)) column = "negtiveRatio";

        final String finalColumn = column;
        Collections.sort(rewAndFdbkDTOs, new Comparator<RewAndFdbkDTO>() {
            @Override
            public int compare(RewAndFdbkDTO r1, RewAndFdbkDTO r2) {
