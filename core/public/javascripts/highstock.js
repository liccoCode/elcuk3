...
(function(){
    ...
    function H(a, b, c){
        var d, e;
        if(ma(b))x(c) ? a.setAttribute(b, c) :a && a.getAttribute && (e = a.getAttribute(b));else if(x(b) && da(b))for(d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function yb(a, b){
        var c = b || [
            [jb, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]],
            [db, [1, 2, 5, 10, 15, 30]],
            [Ya, [1, 2, 5, 10, 15, 30]],
            [ya, [1, 2, 3, 4, 6, 8, 12]],
            [fa, [1, 2]],
            ...
            [La, [1, 2, 3, 4, 6]],
            [sa, null]
        ], d = c[c.length - 1], e = L[d[0]], f = d[1], g;
    ...
    function eb(a, b, c, d){
        ...
        if(x(b)){
            ...
            j >= L[sa] && (h -= h % k, i[Ob](h));
            if(j === L[Ka])i[Bb](i[Ma]() - i[Cb]() + p(d, 1));
            b = 1;
            h = i[lb]();
    ...
    var va = function(a){
        var b = [], c, d;
        (function(a){
            a && a.stops ? d = Ea(a.stops, function(a){
                    return va(a[1])
    ...
    Ba.prototype = {init: function(a, b){
        ...
        if(ma(a))c = a, h === "circle" ? c = {x: "cx", y: "cy"}[c] || c :c === "strokeWidth" && (c = "stroke-width"), q = H(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (q = parseFloat(q));else{
            for(c in a)if(j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1){
                e !== r && (d = e);
                if(c === "d")d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) && (d = "M 0 0");else if(c === "x" && h === "text")for(e = 0; e < g.childNodes.length; e++)f = g.childNodes[e], H(f, "x") === H(g, "x") && H(f, "x", d);else if(this.rotation && (c === "x" || c === "y"))o = !0;else if(c === "fill")d = i.color(d, g, c);else if(h === "circle" && (c === "x" || c === "y"))c = {x: "cx", y: "cy"}[c] || c;else if(h === "rect" && c === "r")H(g, {rx: d, ry: d}), j = !0;else if(c === "translateX" || c === "translateY" || c === "rotation" || c === "verticalAlign" || c === "scaleX" || c === "scaleY")j = o = !0;else if(c === "stroke")d = i.color(d, g, c);else if(c === "dashstyle")if(c = "stroke-dasharray", d = d && d.toLowerCase(), d === "solid")d = ba;else{
                    if(d){
                ...
                }else if(c === "width")d = A(d);else if(c === "align")c = "text-anchor", d = {left: "start", center: "middle",
        ...
        css: function(a){
            ...
            if(!a){
                ...
                if(b.isSVG){
                    ...
                    if(d)a.width = T(c * ja(f)) + T(b * ga(f)), a.height = T(c * ga(f)) + T(b * ja(f))
                }
                this.bBox = a
            }
            return a
    ...
    Fa.prototype = {Element: Ba, init: function(a, b, c, d){
        ...
        this.boxWrapper = f;
        this.alignedObjects = [];
        this.url = (sb || rb) && G.getElementsByTagName("base").length ? e.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") :"";
        ...
        destroy: function(){
            ...
            for(var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /style="([^"]+)"/, h = /href="([^"]+)"/, i = H(b, "x"), j = a.styles, k = j && j.width && A(j.width), m = j && j.lineHeight, l = f.length; l--;)b.removeChild(f[l]);
            ...
            n(e, function(e, f){
                ...
                n(l, function(e){
                    if(e !== "" || l.length === 1){
                        var o = {}, n = G.createElementNS(Da, "tspan"), p;
                        ...
                        b.appendChild(n);
                        u++;
                        if(k)for(var e = e.replace(/([^\^])-/g, "$1- ").split(" "), E, B = []; e.length || B.length;)delete a.bBox, E = a.getBBox().width, o = E > k, !o || e.length === 1 ? (e = B, B = [], e.length && (n = G.createElementNS(Da, "tspan"), H(n, {dy: m || 16, x: i}), p && H(n, "style", p), b.appendChild(n), E > k && (k = E))) :(n.removeChild(n.firstChild), B.unshift(e.pop())), e.length && n.appendChild(G.createTextNode(e.join(" ").replace(/- /g, "-")))
                    }
                })
            })
        }, button: function(a, b, c, d, e, f, g){
            var h = this.label(a, b, c, null, null, null, null, null, "button"), i = 0, j, k, m, l, o, a = {x1: 0,
                y1: 0, x2: 0, y2: 1}, e = w({"stroke-width": 1, stroke: "#CCCCCC", fill: {linearGradient: a, stops: [
                [0, "#FEFEFE"],
                [1, "#F6F6F6"]
            ...
            if(h)g = this.path(h), z(g, {symbolName: a, x: b, y: c, width: d, height: e}), f && z(g, f);else if(i.test(a))k = function(a, b){
            ...
            if(g){
                ...
                g === "radialGradient" && b && !x(c.gradientUnits) && (c = w(c, {cx: b[0] - b[2] / 2 + c.cx * b[2], cy: b[1] - b[2] / 2 + c.cy * b[2], r: c.r * b[2], gradientUnits: "userSpaceOnUse"}));
                ...
                return"url(" + d.url + "#" + a + ")"
            }else return f.test(a) ? (e = va(a), H(b, c + "-opacity", e.get("a")), e.get("rgb")) :(b.removeAttribute(c + "-opacity"), a)
            ...
            function j(){
                var a, b;
                a = N.element.style;
                p = (E === void 0 || B === void 0 || q.styles.textAlign) && N.getBBox();
    ...
    cb = Fa;
    var hb, Y;
    if(!ca && !ha)Highcharts.VMLElement = Y = {init: function(a, b){
        var c = ["<", b, ' filled="f" stroked="f"'], d = ["position: ", "absolute", ";"], e = b === Oa;
        ...
        if(a){
            ...
            for(e = 1; e <= 3; e++){
                ...
                h = aa(g.prepVML(j), null, {left: A(i.left) + p(a.offsetX, 1), top: A(i.top) + p(a.offsetY, 1)});
                if(c)h.cutOff = m + 1;
        ...
        if(i){
            var k, m, l = a.linearGradient || a.radialGradient, o, q, p, u, t, y = "", a = a.stops, s, $ = [], E = function(){
                h = ['<fill colors="' + $.join(",") + '" opacity="', p, '" o:opacity2="', q, '" type="', i, '" ', y, 'focus="100%" method="any" />'];
            ...
            if(c === "fill")if(i === "gradient")c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, o = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, y = 'angle="' + (90 - O.atan((l - a) / (o - c)) * 180 / bb) + '"', E();else{
    ...
    ab.prototype = {addLabel: function(){
        var a = this.axis, b = a.options, c = a.chart, d = a.horiz, e = a.categories, f = a.series[0] && a.series[0].names, g = this.pos, h = b.labels, i = a.tickPositions, d = d && e && !h.step && !h.staggerLines && !h.rotation && c.plotWidth / i.length || !d && (c.optionsMarginLeft || c.plotWidth / 2), j = g === i[0], k = g === i[i.length - 1], f = e ? p(e[g], f && f[g], g) :g, e = this.label, i = i.info, m;
        ...
        getLabelSize: function(){
            ...
            if(q){
                ...
                if(!b && m && j)m[this.isNew ? "attr" :"animate"]({d: j,
                    opacity: c})
            }
            if(l && t)s === "inside" && (t = -t), d.opposite && (t = -t), b = this.getMarkPath(x, S, t, l * v, g, f), o ? o.animate({d: b, opacity: c}) :this.mark = f.path(b).attr({stroke: y, "stroke-width": l, opacity: c}).add(d.axisGroup);
            if(i && !isNaN(x))i.xy = S = this.getLabelPosition(x, S, i, g, k, B, a, $), this.isFirst && !p(e.showFirstLabel, 1) || this.isLast && !p(e.showLastLabel, 1) ? E = !1 :!w && g && k.overflow === "justify" && !this.handleOverflow(a, S) && (E = !1), $ && a % $ && (E = !1), E && !isNaN(S.y) ? (S.opacity = c, i[this.isNew ? "attr" :"animate"](S), this.isNew = !1) :i.attr("y", -9999)
        }, destroy: function(){
            za(this, this.axis)
        }};
    Db.prototype = {render: function(){
        ...
        if(h){
            ...
            if(j = s(j, b.min - d), i = C(i, b.max + d), q = b.getPlotBandPath(j, i, e), d = {fill: u}, e.borderWidth)d.stroke = e.borderColor, d["stroke-width"] = e.borderWidth
        }else return;
        if(x(t))d.zIndex = t;
        ...
        if(f && x(f.text) && q && q.length && b.width > 0 && b.height > 0){
            ...
            if(!g)a.label = g = r.text(f.text, 0, 0).attr({align: f.textAlign || f.align, rotation: f.rotation, zIndex: t}).css(f.style).add();
            b = [q[1], q[4], p(q[6], q[1])];
            q = [q[2], q[5], p(q[7], q[2])];
            c = Na(b);
            k = Na(q);
    ...
    Ca.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"}, endOnTick: !1, gridLineColor: "#C0C0C0", labels: F, lineColor: "#C0D0E0", lineWidth: 1, minPadding: 0.01, maxPadding: 0.01, minorGridLineColor: "#E0E0E0", minorGridLineWidth: 1, minorTickColor: "#A0A0A0", minorTickLength: 2, minorTickPosition: "outside",
        ...
        if(h)g = Xa(h, this);else if(c)g = b;else if(d)g = xa(d, b);else if(f && a >= 1E3)for(; f-- && g === r;)c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Wa(b / c, -1) + e[f]);
        ...
        n(a.series, function(g){
            if(g.visible || !b.options.chart.ignoreHiddenSeries){
                ...
                if(a.isXAxis){
                    if(j = g.xData, j.length)a.dataMin = C(p(a.dataMin, j[0]), Na(j)), a.dataMax = s(p(a.dataMax, j[0]), ta(j))
                }else{
                    ...
                    for(h = 0; h < $; h++){
                        t = j[h];
                        y = u[h];
                        if(k)w = (S = y < v) ? l :m, J = S ? n :o, x(w[t]) ? (w[t] = oa(w[t] + y), y = [y, w[t]]) :w[t] = y, c[J] || (c[J] = {}), c[J][t] || (c[J][t] = new Sb(a, a.options.stackLabels, S, t, q, k)), c[J][t].setTotal(w[t]), c[J][t].touched = f;
        ...
        toValue: function(a, b){
            ...
            if(a >= 0.5)a = v(a), g = this.getLinearTickPositions(a, b, c);else if(a >= 0.08)for(var f = V(b), h, i, j, k, m, e = a > 0.3 ? [1, 2, 4] :a > 0.15 ? [1, 2, 4, 6, 8] :[1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++){
                i = e.length;
            ...
            if(this.isXAxis && this.minRange === r && !this.isLog)x(a.min) || x(a.max) ? this.minRange = null :(n(this.series, function(a){
                i = a.xData;
            ...
            h ? (b.linkedParent = c[g ? "xAxis" :"yAxis"][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin), b.max = p(c.max, c.dataMax), d.type !== b.linkedParent.options.type && Aa(11, 1)) :(b.min = p(b.userMin, d.min, b.dataMin), b.max = p(b.userMax, d.max, b.dataMax));
            ...
            if(!i)i = f ? (b.getNonLinearTimeTicks || eb)(yb(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) :e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) :b.getLinearTickPositions(b.tickInterval, b.min, b.max), b.tickPositions = i;
            ...
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] :h, j, k = 0, m, l = 0, o = d.title, q = d.labels, N = 0, u = b.axisOffset, t = b.clipOffset, y = [-1, 1, 1, -1][h], r;
            ...
            }), a.staggerLines && (N += (a.staggerLines - 1) * 16);else for(r in f)f[r].destroy(), delete f[r];
            ...
            u[h] = s(u[h], a.axisTitleMargin + k + y * a.offset);
            ...
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.stacks, j = a.ticks, k = a.minorTicks, m = a.alternateBands, l = d.stackLabels, o = d.alternateGridColor, q = a.tickmarkOffset, p = d.lineWidth, u, t = b.hasRendered && x(a.oldMin) && !isNaN(a.oldMin);
            u = a.hasData;
            var y = a.showAxis, s, $;
            n([j, k, m], function(a){
            ...
            if(u || f)if(a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function(b){
                ...
                if(c % 2 === 0 && b < a.max)m[b] || (m[b] = new Db(a)), s = b + q, $ = g[c + 1] !== r ? g[c + 1] + q :a.max, m[b].options = {from: e ? la(s) :s, to: e ? la($) :$, color: o}, m[b].render(), m[b].isActive = !0
            ...
            if(p)u = a.getLinePath(p), a.axisLine ? a.axisLine.animate({d: u}) :a.axisLine = c.path(u).attr({stroke: d.lineColor, "stroke-width": p, zIndex: 7}).add(a.axisGroup), a.axisLine[y ? "show" :"hide"]();
    ...
    Eb.prototype = {init: function(a, b){
        ...
        e.label.attr(f);
        if(g && (T(a - f.x) > 1 || T(b - f.y) > 1))clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function(){
            e && e.move(a, b, c, d)
        }, 32)
    }, hide: function(){
        var a = this, b;
        ...
        var d = this.chart, e = d.plotLeft, f = d.plotTop, g = d.plotWidth, h = d.plotHeight, i = p(this.options.distance, 12), j = c.plotX, c = c.plotY, d = j + e + (d.inverted ? i :-a - i), k = c - b + f + 15, m;
        d < 7 && (d = e + s(j, 0) + i);
        ...
        if(l){
            l = ia(l);
            for(d = l.length; d--;)if(e = a.series[d ? "yAxis" :"xAxis"], l[d] && e)if(h = d ? p(a.stackY, a.y) :a.x, e.isLog && (h = ra(h)), e = e.getPlotLinePath(h, 1), this.crosshairs[d])this.crosshairs[d].attr({d: e, visibility: "visible"});else{
    ...
    ob.prototype = {init: function(a, b){
        ...
        drop: function(a){
            ...
            a.cancelBubble = !0;
            if(!b.cancelClick)c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, z(c, {pageX: g.left + d + (f ? b.plotWidth - i :h), pageY: g.top + e + (f ? b.plotHeight - h :i)}), D(c.series, "click", z(a, {point: c})), c.firePointEvent("click", a)) :(z(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && D(b, "click", a))
        ...
        setDOMEvents: function(){
            ...
            this._events = c = [
                ...
                [G, "mousemove", "onDocumentMouseMove"],
                [G, "mouseup", "onDocumentMouseUp"]
            ];
            ...
            n(c, function(b){
                ...
                b[1].indexOf("on") === 0 ? b[0][b[1]] = a["_" + b[2]] :I(b[0], b[1], a["_" + b[2]])
            })
        }, destroy: function(){
            var a = this;
    ...
    Fb.prototype = {init: function(a, b){
        ...
        this.options = b;
        if(b.enabled)c.baseline = A(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = w(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.render(), I(c.chart, "endResize", function(){
        ...
        if(!p && (a.legendGroup = d.g("legend-item").attr({zIndex: 1}).add(b.scrollGroup), t.drawLegendSymbol(b, a), a.legendItem = p = d.text(e.labelFormat ? Xa(e.labelFormat, a) :e.labelFormatter.call(a), m ? g + h :-h, b.baseline, v).css(w(a.visible ? i :j)).attr({align: m ? "left" :"right", zIndex: 2}).add(a.legendGroup), (v ? p :a.legendGroup).on("mouseover",function(){
            a.setState("hover");
            ...
            }), b.colorizeItem(a, a.visible), y && r))a.checkbox = aa("input", {type: "checkbox", checked: a.selected,
        ...
        if(m || l){
            ...
            }else a.box = i = c.rect(0, 0, g, h, j.borderRadius, m || 0).attr({stroke: j.borderColor, "stroke-width": m || 0, fill: l || ba}).add(d).shadow(j.shadow), i.isNew = !0;
            i[f ? "show" :"hide"]()
        }
        a.legendWidth = g;
        a.legendHeight = h;
    ...
    Qa.prototype = {init: function(a, b){
        ...
        isInsidePlot: function(a, b, c){
            ...
            if(!c)this.loadingDiv = c = aa(Oa, {className: "highcharts-loading"}, z(d.style, {zIndex: 10, display: ba}), this.container), this.loadingSpan = aa("span", null, d.labelStyle, c);
            this.loadingSpan.innerHTML = a || b.lang.loading;
            if(!this.loadingShown)M(c, {opacity: 0, display: "", left: this.plotLeft + "px", top: this.plotTop + "px", width: this.plotWidth + "px", height: this.plotHeight + "px"}), Kb(c, {opacity: d.style.opacity}, {duration: d.showDuration || 0}), this.loadingShown = !0
            ...
            return Xb(this.series, function(a){
                    return a.selected
                })
            ...
            a ? b && (this.renderTo.appendChild(c), Za(b), delete this.renderToClone) :(c && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), M(b, {position: "absolute", top: "-9999px", display: "block"}), G.body.appendChild(b), c && b.appendChild(c))
            ...
            var a = this.options.chart, b = a.spacingTop, c = a.spacingRight, d = a.spacingBottom, a = a.spacingLeft, e, f = this.legend, g = this.optionsMarginTop, h = this.optionsMarginLeft, i = this.optionsMarginRight, j = this.optionsMarginBottom, k = this.options.title, m = this.options.subtitle, l = this.options.legend, o = p(l.margin, 10), q = l.x, N = l.y, u = l.align, t = l.verticalAlign;
            this.resetMargins();
            e = this.axisOffset;
            if((this.title || this.subtitle) && !x(this.optionsMarginTop))if(m = s(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !m.floating && !m.verticalAlign && m.y || 0))this.plotTop = s(this.plotTop, m + p(k.margin, 15) + b);
            ...
            if(l)g ? g.animate(g.crisp(null, q, n, p, t)) :this.plotBorder = b.rect(q, n, p, t, 0, l).attr({stroke: a.plotBorderColor, "stroke-width": l, zIndex: 1}).add();
            this.isDirtyBox = !1
    ...
    Ga.prototype = {init: function(a, b, c){
        ...
        if(!b || ua(this, b) === -1)this.firePointEvent("mouseOut"), this.setState(), a.hoverPoint = null
        ...
        var b = this.plotX, c = this.plotY, d = this.series, e = d.options.states, f = R[d.type].marker && d.options.marker, g = f && !f.enabled, h = f && f.states[a], i = h && h.enabled === !1, j = d.stateMarkerGraphic, k = this.marker || {}, m = d.chart, l = this.pointAttr, a = a || "";
        if(!(a === this.state || this.selected && a !== "select" || e[a] && e[a].enabled === !1 || a && (i || g && !h.enabled))){
            if(this.graphic)e = f && this.graphic.symbolName && l[a].r, this.graphic.attr(w(l[a], e ? {x: b - e, y: c - e, width: 2 * e, height: 2 * e} :{}));else{
    ...
    Z.prototype = {isCartesian: !0, type: "line", pointClass: Ga, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, colorCounter: 0, init: function(a, b){
        ...
        this.bindAxes();
        z(this, {name: b.name, state: "", pointAttr: {}, visible: b.visible !== !1, selected: b.selected === !0});
        if(ha)b.animation = !1;
        d = b.events;
        ...
        c = b.linkedTo;
        this.linkedSeries = [];
        if(ma(c) && (c = c === ":previous" ? e[this.index - 1] :a.get(c)))c.linkedSeries.push(this), this.linkedParent = c
    }, bindAxes: function(){
        ...
        if(!this.symbol)x(a._symbolIndex) ? a = a._symbolIndex :(a._symbolIndex = c.symbol, a = c.symbol++), this.symbol = d[a];
        ...
        for(k = 0; k < g; k++){
            ...
            if(b && this.visible && n && n[l])q = n[l], n = q.total, q.cum = q = q.cum - o, o = q + o, i && (q = p(a, e.min)), e.isLog && q <= 0 && (q = null), b === "percent" && (q = n ? q * 100 / n :0, o = n ? o * 100 / n :0), j.percentage = n ? j.y * 100 / n :0, j.total = j.stackTotal = n, j.stackY = o;
        ...
        var f = this.chart, g = f.inverted, h = p(a.plotX, -999), a = p(a.plotY, -999), i = b.getBBox(), d = z({x: g ? f.plotWidth - a :h, y: v(g ? f.plotHeight - h :a), width: 0, height: 0}, d);
        ...
        if(j)j.attr({d: d});else if(a.tracker = j = h.path(d).attr({"class": "highcharts-tracker", "stroke-linejoin": "round", visibility: a.visible ? "visible" :"hidden",
    ...
    Y = ea(Z, {type: "column", tooltipOutsidePlot: !0, requireSorting: !1, pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth",
        ...
        var a = this, b = a.chart, c = a.options, d = c.stacking, e = c.borderWidth, f = a.yAxis, g = a.translatedThreshold = f.getThreshold(c.threshold), h = p(c.minPointLength, 5), c = a.getColumnMetrics(), i = c.width, j = pa(s(i, 1 + 2 * e)), k = c.offset;
        ...
        drawGraph: qa, drawPoints: function(){
            ...
            if(ca)a ? (e.scaleY = 0.001, a = C(b.pos + b.len, s(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len :e.translateY = a, this.group.attr(e)) :(e.scaleY = 1, e[d ? "translateX" :"translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        }, remove: function(){
            var a = this, b = a.chart;
            b.hasRendered && n(b.series, function(b){
                if(b.type === a.type)b.isDirty = !0
    ...
    Q = {type: "pie", isCartesian: !1, pointClass: ea(Ga, {init: function(){
        ...
        requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "dataLabelsGroup"], pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color"}, getColor: qa, animate: function(a){
            ...
            for(q = 0; q < n; q++){
                ...
                i = (h + g) / 2;
                i > 0.75 * m && (i -= 2 * bb);
                p.slicedTranslation = {translateX: v(ga(i) * e), translateY: v(ja(i) * e)};
                g = ga(i) * a[2] / 2;
                h = ja(i) * a[2] / 2;
            ...
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, j, k = p(e.softConnector, !0), m = e.distance, l = a.center, o = l[2] / 2, q = l[1], r = m > 0, u, t, y, x, w = [
                [],
                []
            ], E, B, z, A, J, C = [0, 0, 0, 0], I = function(a, b){
                return b.y - a.y
            }, H = function(a, b){
                a.sort(function(a, c){
    ...
    Q = ea(Z, Q);
    P.pie = Q;
    var U = Z.prototype, ec = U.processData, fc = U.generatePoints, gc = U.destroy, hc = U.tooltipHeaderFormatter, ic = {approximation: "average", groupPixelWidth: 2, dateTimeLabelFormats: ib(jb, ["%A, %b %e, %H:%M:%S.%L", "%A, %b %e, %H:%M:%S.%L", "-%H:%M:%S.%L"], db, ["%A, %b %e, %H:%M:%S", "%A, %b %e, %H:%M:%S", "-%H:%M:%S"], Ya, ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M"], ya, ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M"], fa, ["%A, %b %e, %Y", "%A, %b %e", "-%A, %b %e, %Y"], Ka, ["Week from %A, %b %e, %Y", "%A, %b %e", "-%A, %b %e, %Y"], La, ["%B %Y", "%B", "-%B %Y"], sa, ["%Y", "%Y", "-%Y"])}, $b = {line: {}, spline: {}, area: {}, areaspline: {}, column: {approximation: "sum", groupPixelWidth: 10}, arearange: {approximation: "range"}, areasplinerange: {approximation: "range"}, columnrange: {approximation: "range", groupPixelWidth: 10}, candlestick: {approximation: "ohlc", groupPixelWidth: 10}, ohlc: {approximation: "ohlc",
        groupPixelWidth: 5}}, ac = [
        [jb, [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]],
        [db, [1, 2, 5, 10, 15, 30]],
        [Ya, [1, 2, 5, 10, 15, 30]],
        [ya, [1, 2, 3, 4, 6, 8, 12]],
        ...
        return a.length ? Na(a) :a.hasNulls ? null :r
    }, close: function(a){
    ...
    U.groupData = function(a, b, c, d){
        var e = this.data, f = this.options.data, g = [], h = [], i = a.length, j, k, m = !!b, l = [
            ...
            [],
            []
        ], d = typeof d === "function" ? d :Ha[d], o = this.pointArrayMap, q = o && o.length, n;
        for(n = 0; n <= i; n++){
    ...
    Q = ea(P.column, {type: "ohlc", pointArrayMap: ["open", "high", "low", "close"], toYData: function(a){
        ...
        for(d = 0; d < f; d++)if(c = e[d], b = d > 0 ? e[d - 1].close < c.close :c.open < c.close)c.pointAttr = a
    }, translate: function(){
        var a = this.yAxis;
    ...
    Q = ib("linearGradient", {x1: 0, y1: 0, x2: 0, y2: 1}, "stops", [
        [0, "#FFF"],
        [1, "#CCC"]
    ]);
    F = [].concat(ac);
    ...
    z(K, {navigator: {handles: {backgroundColor: "#FFF", borderColor: "#666"}, height: 40, margin: 10, maskFill: "rgba(255, 255, 255, 0.75)", outlineColor: "#444", outlineWidth: 1, series: {type: "areaspline", color: "#4572A7", compare: null, fillOpacity: 0.4, dataGrouping: {approximation: "average", groupPixelWidth: 2, smoothed: !0, units: F}, dataLabels: {enabled: !1}, id: "highcharts-navigator-series", lineColor: "#4572A7", lineWidth: 1, marker: {enabled: !1},
        ...
        trackBackgroundColor: ib("linearGradient", {x1: 0, y1: 0, x2: 0, y2: 1}, "stops", [
            [0, "#EEE"],
            [1, "#FFF"]
        ]), trackBorderColor: "#CCC", trackBorderWidth: 1, liveRedraw: ca}});
    Gb.prototype = {drawHandle: function(a, b){
        ...
        if(!isNaN(a)){
            ...
            if(r)this.drawScrollbarButton(0), this.drawScrollbarButton(1), k[e]({translateX: i, translateY: v(F + x)}), o[e]({width: j}), g = n + d, h = c - G, h < y && (D = (y - h) / 2, h = y, g -= D), this.scrollbarPad = D, l[e]({x: V(g) + G % 2 / 2, width: h}), y = n + d + c / 2 - 0.5, this.scrollbarRifles.attr({visibility: c > 12 ? "visible" :"hidden"})[e]({d: ["M", y - 3, n / 4, "L", y - 3, 2 * n / 3, "M", y, n / 4, "L", y, 2 * n / 3, "M", y + 3, n / 4, "L", y + 3, 2 * n / 3]});
            this.scrollbarPad = D;
            this.rendered = !0
        }
    }, addEvents: function(){
        ...
        this._events = r;
        this.navigatorEnabled && this.baseSeries && W(this.baseSeries, "updatedData", this.updatedDataHandler)
    }, init: function(){
        ...
        a.mouseDownHandler = function(d){
            ...
            if(u > h && u < h + g + i)if((h = !a.scrollbarEnabled || u < h + g) && O.abs(t - e - n) < s)a.grabbedLeft = !0, a.otherHandlePos = f;else if(h && O.abs(t - f - n) < s)a.grabbedRight = !0, a.otherHandlePos = e;else if(t > n + e - q && t < n + f + q){
                a.grabbedCenter = t;
        ...
        a.mouseUpHandler = function(d){
            k && b.xAxis[0].setExtremes(c.translate(a.zoomedMin, !0), c.translate(a.zoomedMax, !0), !0, !1, {trigger: "navigator"});
        ...
        a.updatedDataHandler = function(){
            ...
            r && (j || k) ? c.setExtremes(m, l, !0, !1, {trigger: "updatedData"}) :(p && b.redraw(!1), a.render(s(e, g), C(f, d)))
        };
        ...
        if(a.navigatorEnabled){
            ...
            r = w(t, v, {threshold: null, clip: !1, enableMouseTracking: !1, group: "nav", padXAxis: !1, xAxis: r, yAxis: u, name: "Navigator", showInLegend: !1, isInternal: !0, visible: !0});
            r.data = n || y;
            i = b.initSeries(r);
    ...
    wa(Ca.prototype, "zoom", function(a, b, c){
        ...
        if(this.isXAxis && (g && g.enabled || e && e.enabled))if(f === "x")d.resetZoomButton = "blocked";else if(f === "y")h = !1;else if(f === "xy")d = this.previousZoom, x(b) ? this.previousZoom = [this.min, this.max] :d && (b = d[0], c = d[1], delete this.previousZoom);
    ...
    K.lang = w(K.lang, {rangeSelectorZoom: "Zoom", rangeSelectorFrom: "From", rangeSelectorTo: "To"});
    Hb.prototype = {clickButton: function(a, b, c){
        ...
        if(!(l === null || o === null || a === d.selected)){
            if(m[j])v = m[j] * k, q = s(h - v, l);else if(j === "month")i.setMonth(i.getMonth() - k), q = s(i.getTime(), l), v = 2592E6 * k;else if(j === "ytd")if(g){
                ...
                return
            }else j === "year" ? (i.setFullYear(i.getFullYear() - k), q = s(l, i.getTime()), v = 31536E6 * k) :j === "all" && g && (q = l, h = o);
            f[a] && f[a].setState(2);
        ...
        i.onchange = function(){
            ...
            if(!isNaN(d) && (K.global.useUTC || (d += (new Date).getTimezoneOffset() * 6E4), h && d >= e.dataMin && d <= b.maxInput.HCTime || !h && d <= e.dataMax && d >= b.minInput.HCTime))c.xAxis[0].setExtremes(h ? d :e.min, h ? e.max :d, r, r, {trigger: "rangeSelectorInput"})
        }
    }, render: function(a, b){
        ...
        if(!c.rendered && (c.zoomText = e.text(k.rangeSelectorZoom, r, d.plotTop - 10).css(i.labelStyle).add(), u = r + c.zoomText.getBBox().width + 5, n(c.buttonOptions, function(a, b){
            ...
            }), o))c.div = m = aa("div", null, {position: "relative", height: 0, zIndex: 1}), f.parentNode.insertBefore(m, f), c.inputGroup = m = e.g("input-group").add(), m.offset = 0, c.drawInput("min"), c.drawInput("max");
        o && (f = d.plotTop - 35, m.align(z({y: f, width: m.offset, x: h && f < (h.y || 0) + h.height - g.chart.spacingTop ? -40 :0}, i.inputPosition), !0, d.spacingBox), c.setInputValue("min", a), c.setInputValue("max", b));
        c.rendered = !0
    }, destroy: function(){
            ...
            if(d && d.options.ordinal && !d.hasOrdinalExtension){
                ...
                d.lin2val = function(a, b){
                    ...
                    if(c){
                        ...
                        return l !== r && c[k] !== r ? c[k] + (l ? l * (c[k + 1] - c[k]) :0) :a
                    }else return a
                };
                d.getExtendedPositions = function(){
                    ...
                    if(!e[h])j = {series: [], getExtremes: function(){
                        ...
                        k.options = {dataGrouping: a ? {enabled: !0, forced: !0, approximation: "open", units: [
                            [a.unitName, [a.count]]
                        ]} :{enabled: !1}};
                ...
                d.getNonLinearTimeTicks = function(a, b, c, e, j, k, m){
                    var l = 0, n = 0, p, s = {}, u, t, v, w = [], z = -Number.MAX_VALUE, A = d.options.tickPixelInterval;
                    ...
                    if(m && x(A)){
                        ...
                        for(u = []; m--;)l = d.translate(w[m]), B && (u[m] = B - l), n[m] = B = l;
                        u.sort();
                        u = u[V(u.length / 2)];
                        u < A * 0.6 && (u = null);
                        m = w[a - 1] > c ? a - 1 :a;
                ...
                b.pan = function(a){
                    ...
                    if(d.options.ordinal && d.series.length){
                        ...
                        o = b.hoverPoints;
                        var p = d.closestPointRange, i = (i - a) / (d.translationSlope * (d.ordinalSlope || p)), r = {ordinalPositions: d.getExtendedPositions()}, u, p = d.lin2val, t = d.val2lin;
