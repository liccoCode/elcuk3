    ...
    function o(d, h){
        ...
        a.extend(i, {show:function(b){
            if(!(d.attr("readonly") || d.attr("disabled") || C)){
                ...
                var e = d.offset();
                /iPad/i.test(navigator.userAgent) && (e.top -= a(window).scrollTop()), r.css({top:e.top + d.outerHeight({margins:!0}) + h.offset[0], left:e.left + h.offset[1]}), h.speed ? r.show(h.speed, function(){
                    N(b)
                }) :(r.show(), N(b));
                return i
            }
